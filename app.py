...
st.set_page_config(
    page_title="Shield Recruitment Agent",
    page_icon="#",
    layout="wide"
)

import AI_Recruitment_Agent_Using_Langchain.ui as ui
from AI_Recruitment_Agent_Using_Langchain.agent import ResumeAnalysisAgent
import atexit
...
def main():
    ...
    # Create tabs for different functionalities (removed "Improved Resume" tab)
    tabs = st.tabs([
        "Resume Analysis",
        "Resume Q&A", 
        "Interview Questions",
    ...
    #             has_resume=True,
    #             get_improved_resume_func=lambda areas, role: improve_resume(st.session_state.resume_agent, areas, role)
    #         )
    #     else:
    #         st.warning("Please upload and analyze a resume first in the 'Resume Analysis' tab.")
    # Tab 4: Resume Improvement
